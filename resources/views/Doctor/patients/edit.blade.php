    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
                ...
                <form action="{{ route('doctor.patients.update', $patient) }}" method="POST" class="space-y-6">
                    @csrf @method('PUT')

                    {{-- UID (read-only) --}}
                    <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg flex items-center gap-3">
                        <span class="text-xs text-gray-500 font-medium uppercase">Patient UID</span>
                        <span class="text-sm font-mono font-bold text-gray-800 dark:text-white">
                            {{ $patient->patient_uid }}
                        </span>
                        <span class="text-xs text-gray-400">(cannot be changed)</span>
                    </div>
