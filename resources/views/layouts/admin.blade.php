        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-1 sm:-my-px sm:ms-8 sm:flex items-center">
                   ...
                   {{-- Hospitals --}}
                   <x-nav-link :href="route('admin.hospitals.index')" :active="request()->routeIs('admin.hospitals.*')">
                       <div class="flex items-center gap-2">
                        ...
                        <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-700">
                            <div class="flex items-center gap-2">
                                ...
                                <span x-show="unreadCount > 0" x-text="unreadCount + ' new'"
                                      class="px-1.5 py-0.5 text-xs bg-red-100 text-red-700 font-medium rounded-full"></span>
                            </div>
                            <div class="flex items-center gap-3">
                                ...
                                <a href="{{ route('notifications.index') }}" class="text-xs text-gray-500 hover:text-gray-700">View all</a>
                            </div>
                        </div>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center gap-2 px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition">
                            <div class="w-7 h-7 rounded-full bg-gray-800 flex items-center justify-center text-white text-xs font-bold"
                    ...
                    <x-slot name="content">
                        <div class="px-4 py-2 border-b border-gray-100">
                            ...
                            <span class="inline-block mt-1 px-2 py-0.5 text-xs bg-gray-800 text-white rounded-full font-medium">Admin</span>
                        </div>
