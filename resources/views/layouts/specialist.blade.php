...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('specialist.dashboard') }}" class="text-lg font-bold text-purple-600 dark:text-purple-400">
                ...
                <div class="hidden space-x-1 sm:-my-px sm:ms-8 sm:flex items-center">
                    <x-nav-link :href="route('specialist.dashboard')" :active="request()->routeIs('specialist.dashboard')">
                        Dashboard
                    </x-nav-link>
                    <x-nav-link :href="route('specialist.cases.index')" :active="request()->routeIs('specialist.cases.*')">
                        My Cases
                    </x-nav-link>
                </div>
            </div>
                        ...
                        <div class="max-h-80 overflow-y-auto divide-y divide-gray-50 dark:divide-gray-700">
                            ...
                            <template x-for="n in notifications" :key="n.id">
                                <div @click="markRead(n)"
                                    ...
                                    <div x-show="!n.is_read" class="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0 mt-2"></div>
                                </div>
                            </template>
                        </div>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <div class="px-4 py-2 border-b border-gray-100">
                            ...
                            <span class="inline-block mt-1 px-2 py-0.5 text-xs bg-purple-100 text-purple-800 rounded-full font-medium">Specialist</span>
                        </div>
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden border-t border-gray-100">
        <div class="pt-2 pb-3 space-y-1 px-4">
            <x-responsive-nav-link :href="route('specialist.dashboard')" :active="request()->routeIs('specialist.dashboard')">Dashboard</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('specialist.cases.index')" :active="request()->routeIs('specialist.cases.*')">My Cases</x-responsive-nav-link>
        </div>
