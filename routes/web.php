...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('users/{user}/staff-card', [UserController::class, 'staffCard'])
        ->name('users.staff-card');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('clinical-cases/{clinicalCase}/similar/{similarCase}', [ClinicalCaseController::class, 'similarInsight'])->name('clinical-cases.similar');
    Route::get('clinical-cases/{clinicalCase}/attachments/{attachment}', [ClinicalCaseController::class, 'attachment'])->name('clinical-cases.attachments.show');
